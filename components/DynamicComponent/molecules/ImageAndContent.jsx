...
export default function ImageAndContent({ blok }) {
  return (
    <section
      className={cn("image-and-content-section mt-12 lg:my-20 lg:px-6", {
    ...
    >
      <div
        className={cn(
          ...
          "image-and-content mx-auto max-w-screen-xl border-b-[140px] border-b-white px-6 py-12 lg:border-b-0 lg:py-20",
          {
